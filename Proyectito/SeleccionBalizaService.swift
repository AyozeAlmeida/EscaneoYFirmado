...
class SeleccionBalizaService: NSObject {
    ...
    func obtenerBalizas(callback:@escaping ([Baliza]) -> ())  -> Void {
        ...
        balizas = [Baliza(uuid: "3340CF08-2A4C-47F4-A360-3FA75561F7A2") , Baliza(uuid: "33550CF08-2A4C-47F4-A360-3FA75561F7A2")  ]
